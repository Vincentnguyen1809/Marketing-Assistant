    ...
    <div className="min-h-screen bg-slate-50 flex">
      <div className="w-64 bg-slate-900 text-white p-6 flex flex-col h-screen sticky top-0">
        ...
        <nav className="space-y-2 flex-1">
          ...
          ${currentUser?.role === 'super_admin' && html`
            <button 
        ...
        ${activeTab === 'content' && html`
          <div className="space-y-8 max-w-4xl">
             ...
             <div className="bg-white p-6 rounded-xl shadow border border-slate-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ${tempConfig.metrics.map((metric, idx) => html`
          ...
          <div className="space-y-8 max-w-4xl">
            ...
            <div className="bg-white p-6 rounded-xl shadow border border-slate-200">
              ...
              <div className="grid gap-6">
                 ${tempConfig.videoPortfolio.map((video, idx) => html`
