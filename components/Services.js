...
const getIcon = (name, color) => {
  ...
  switch (name) {
    case 'Target': return html`<${Target} className="w-10 h-10" style=${style} />`;
    case 'ShieldCheck': return html`<${ShieldCheck} className="w-10 h-10" style=${style} />`;
    case 'Zap': return html`<${Zap} className="w-10 h-10" style=${style} />`;
    default: return html`<${Target} className="w-10 h-10" style=${style} />`;
  }
};
      ...
      <div className="container mx-auto px-6">
          ...
          <div className="md:w-1/3">
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
              ...
              <ul className="space-y-4">
                ${productExpertise.map((product, idx) => html`
        ...
        <div className="border-t border-slate-200 pt-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ${videoPortfolio.map((video, idx) => html`
