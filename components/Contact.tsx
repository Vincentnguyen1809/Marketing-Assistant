...
export const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Logic to send email notification to xuanthuongqtkd@gmail.com
      // Using FormSubmit.co service which works for static sites
      const response = await fetch("https://formsubmit.co/ajax/xuanthuongqtkd@gmail.com", {
        method: "POST",
        headers: { 
        ...
        body: JSON.stringify({
          ...
          _template: 'table', // Formats the email nicely for you
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-400">Assistant@7xcrm.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-400">678 722 3447</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-400">1424 N Brown Rd #450<br/>Lawrenceville, GA 30043</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 bg-white rounded-2xl p-8 text-slate-900 shadow-2xl">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit"
                disabled={isSubmitting}
                className={`w-full py-4 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-amber-500/30 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
              >
                {isSubmitting ? (
                  <>
